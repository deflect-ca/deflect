...
def static_files_location(site, global_config, edge_https, origin_https):
    ...
    location = nginx.Location(
        '~* \.(css|js|json|png|gif|ico|jpg|jpeg|svg|ttf|woff|woff2|avi|bin|bmp|dmg|doc|docx|dpkg|exe|flv|htm|html|ics|img|m2a|m2v|mov|mp3|mp4|mpeg|mpg|msi|pdf|pkg|png|ppt|pptx|ps|rar|rss|rtf|swf|tif|tiff|txt|wmv|xhtml|xls|xml|zip)$')
